...
/*   module Controller (
   ...
   //--------------------------------------------------------parameters---------------------------------------------------
       ...
       parameter med_heating = 12'd35; //12'd35; //enter med heating time => depends on temp     => 2.5 mins
       parameter hig_heating = 12'd70; //12'd70; //enter hig heating time => depends on temp     => 5 mins
       parameter low_pouring = 12'd28; //12'd28; //enter low pouring time => depends on level    => 2 mins
       parameter med_pouring = 12'd42; //12'd42; //enter med pouring time => depends on level    => 3 mins
       parameter hig_pouring = 12'd56; //12'd56; //enter hig pouring time => depends on level    => 4 mins
       /*
       ...
       parameter low_timer = 12'd70; //12'd70; //enter time for low duration wash => depends on timer
       parameter med_timer = 12'd210; //12'd210; //enter time for low duration wash => depends on timer
       parameter hig_timer = 12'd420; //12'd420; //enter time for low duration wash => depends on timer
               ...
               begin
                 ...
                 //     		  waiting <= 1'b0;
                   ...
                   if((counter1 != 12'b0)  && (counter2 != 32'b0))
                       ...
                       counter2 <= 32'hffffffff;//32'd8; //32'hffffffff;
                   else 
                       counter2 <= 32'hffffffff;//32'd8; //32'hffffffff;
